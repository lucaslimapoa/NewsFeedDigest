...
func createMockSources() -> [NewsAPISource] {
    return [
        ...
        NewsAPISource(id: "c", name: "C", sourceDescription: "", url: "", category: Category.gaming, language: .english, country: .unitedStates, sortBysAvailable: [.top]),
        NewsAPISource(id: "b", name: "B", sourceDescription: "", url: "", category: Category.technology, language: .english, country: .unitedStates, sortBysAvailable: [.top]),
